...
public class JDialogLoading extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(373, 166));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogLoading.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                JDialogLoading dialog = new JDialogLoading(new javax.swing.JFrame(), true);
